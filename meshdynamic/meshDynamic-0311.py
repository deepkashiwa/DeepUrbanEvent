...
def genGridTransit(mesh, gTrajFileName, transitFileName):
    ...
    Timestamps = getTimestamps(gTrajFileName)
    GridImageIndex = getGridImageIndex()
...
def runCrowdDensity():
    dataPATH = '../interpo_data/'
    # dates = ['20110902', '20110903', '20110904', '20110905', '20110906', '20110907', '20110908']
    dates = ['20110301', '20110302', '20110303', '20110304', '20110305',
             '20110306', '20110307', '20110308', '20110309', '20110310',
             '20110311']
    meshTokyo = Mesh('tokyo', '500m')
    meshcode_level = 4
    ...
    # for date in dates:
    #     dynamicFileName = dataPATH + date + 'tokyo_' + meshTokyo.size + '_5min_popmobmap.csv'
    #     dynamicFileName1 = dataPATH + date + 'tokyo_' + meshTokyo.size + '_5min_popmobmaplog10100.csv'
    #     dynamicFileName2 = dataPATH + date + 'tokyo_' + meshTokyo.size + '_5min_popmobmaploge100.csv'
    #     getRfromDynamicMeshMobmap(meshcode_level, dynamicFileName, dynamicFileName1, dynamicFileName2)
        # R1 = np.log10(R + 1) * 100
        # R2 = np.log(R + 1) * 100
        # getDynamicMeshRtoMobmap(R1, trajFileName, dynamicFileName1, meshcode_level)
        # getDynamicMeshRtoMobmap(R2, trajFileName, dynamicFileName2, meshcode_level)

    # startTimestamp, endTimestamp = '2011-09-01 08:00:00', '2011-09-01 09:00:00'
    # for date in dates:
        # genMeshDynamicTimeInterval(dataPATH + date + 'tokyo_' + meshTokyo.size + '_5min.csv',
        #                dataPATH + date + 'tokyo_' + meshTokyo.size + '_5min_pop.csv', startTimestamp, endTimestamp)

        # genMeshDynamicTimeInterval(dataPATH + date + 'tokyo_' + meshTokyo.size + '_5min.csv',
        #                dataPATH + date + 'tokyo_' + meshTokyo.size + '_5min_popmobmap.csv', startTimestamp, endTimestamp)
        # pass
