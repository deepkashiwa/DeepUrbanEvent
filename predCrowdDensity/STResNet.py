...
def stresnet(c_dim=(3, 80, 80, 1), p_dim=(1, 80, 80, 1), t_dim=(1, 80, 80, 1), residual_units=2, dayInfo_dim=8):
    '''
       Input
       C - Temperal closeness
       P - Period
       T - Trend
       dim = (len_sequence, map_height, map_width, nb_channel)
    ...
    for dim in [c_dim, p_dim, t_dim]:
        if dim is not None:
            len_sequence, map_height, map_width, nb_channel = dim
